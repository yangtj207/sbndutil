...
# Usage:
#
# make_xml_mcp.sh [-h|--help] [-r <release>] [-u|--user <user>] [--local <dir|tar>] [--nev <n>] [--nevjob <n>] [--nevgjob <n>]
#
# Options:
#
# -h|--help     - Print help.
# --name <name> - The name of the production e.g. mcp1.0
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    -h|--help )
      echo "Usage: make_xml_mcp.sh [-h|--help] [--name <prodution name e.g. mcp1.0>] [-r <release>] [-q <qual>] [-u|--user <user>] [--local <dir|tar>] [--nev <n>] [--nevjob <n>] [--nevgjob <n>]"
      exit
    ;;
