...
do
  if ! echo $fcl | grep -q common; then
    ...
    g4fcl=g4/standard_g4_lar1nd.fcl

    # Detsim (optical + tpc).

    detsimfcl=''
    #if echo $newprj | grep -q 3window; then
    #  detsimfcl=detsim/standard_detsim_3window_lar1nd.fcl
    #fi
    ...
    optsimfcl=''
    #if echo $newprj | grep -q 3window; then
    #  optsimfcl=detsim/standard_detsim_3window_lar1nd_optical.fcl
    #fi
    #echo "Using ${optsimfcl}."

    # Detsim tpc

    tpcsimfcl=detsim/standard_detsim_lar1nd.fcl
    if echo $newprj | grep -q 3window; then
      tpcsimfcl=detsim/standard_detsim_3window_lar1nd_tpc.fcl
    fi
    echo "Using ${tpcsimfcl}."

    # Reco 2D

    reco2dfcl=reco/standard_reco_lar1nd_2D_noopt_nowires.fcl
    if echo $newprj | grep -q cosmic; then
      reco2dfcl=reco/standard_reco_lar1nd_2D_noopt_nowires_cosmic.fcl
    fi
    echo "Using ${reco2dfcl}."

    # Reco 3D

    reco3dfcl=reco/standard_reco_lar1nd_3D_noopt.fcl
    if echo $newprj | grep -q cosmic; then
      reco3dfcl=reco/standard_reco_lar1nd_3D_noopt_cosmic.fcl
    fi
    ...
    if [ $nev -eq 0 ]; then
      if [ $newprj = prodgenie_bnb_nu_cosmic_3window_lar1nd ]; then
        nev=50000
      elif [ $newprj = prodgenie_bnb_nu_3window_lar1nd ]; then
        nev=20000
      else
        nev=10000
      fi
...
<project name="&name;">
  ...
  <stage name="gen">
    <fcl>$genfcl</fcl>
    <outdir>/lar1nd/data/${userdir}/gen/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/gen/&release;/&name;</workdir>
  ...
  <stage name="g4">
    <fcl>$g4fcl</fcl>
    <outdir>/lar1nd/data/${userdir}/g4/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/g4/&release;/&name;</workdir>
    <numjobs>$njob</numjobs>
...
EOF
  ...
  <stage name="detsim">
    <fcl>$detsimfcl</fcl>
    <outdir>/lar1nd/data/${userdir}/detsim/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/detsim/&release;/&name;</workdir>
    <numjobs>$njob</numjobs>
...
EOF
  ...
  <stage name="optsim">
    <fcl>$optsimfcl</fcl>
    <outdir>/lar1nd/data/${userdir}/optsim/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/optsim/&release;/&name;</workdir>
    <numjobs>$njob</numjobs>
    <datatier>optical-simulated</datatier>
...
EOF
  ...
  <stage name="tpcsim">
    <fcl>$tpcsimfcl</fcl>
    <outdir>/lar1nd/data/${userdir}/tpcsim/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/tpcsim/&release;/&name;</workdir>
    <numjobs>$njob</numjobs>
...
EOF
  ...
  <stage name="reco2D">
    <fcl>$reco2dfcl</fcl>
    <outdir>/lar1nd/data/${userdir}/reco2D/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/reco2D/&release;/&name;</workdir>
    <numjobs>$njob</numjobs>
  ...
  <stage name="reco3D">
    <fcl>$reco3dfcl</fcl>
    <outdir>/lar1nd/data/${userdir}/reco3D/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/reco3D/&release;/&name;</workdir>
    <numjobs>$njob</numjobs>
  ...
  <stage name="merge">
    <fcl>$mergefcl</fcl>
    <outdir>/lar1nd/data/${userdir}/reco/&release;/&name;</outdir>
    <workdir>/lar1nd/app/users/${userdir}/reco/&release;/&name;</workdir>
    <numjobs>$njob</numjobs>
